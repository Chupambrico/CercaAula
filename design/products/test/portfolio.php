    ...
    <div class="page-content" id="content">
      ...
      <div class="container no-bottom">
            <div class="portfolio-item-full-width">
        		<a href="images/slider/1.jpg" class="cboxElement">
                	<img alt="img" src="images/slider/1.jpg" class="responsive-image">
        	...
        	<div class="portfolio-item-full-width">
        		<a href="images/slider/2.jpg" class="cboxElement">
                	<img alt="img" src="images/slider/2.jpg" class="responsive-image">
                    Image Caption Goes Here
                </a>
				<h5 class="uppercase">A full width portfolio item!</h5>
                <p>We like portfolios a lot! We've optimized them to the extreme to make them work like a charm on mobiles!</p>
            ...
            <div class="decoration"></div>
        	<div class="portfolio-item-full-width">
        		<a href="images/slider/3.jpg" class="cboxElement">
                	<img alt="img" src="images/slider/3.jpg" class="responsive-image">
                    Image Caption Goes Here
                </a>
                <h5 class="uppercase">A full width portfolio item!</h5>
                <p>We like portfolios a lot! We've optimized them to the extreme to make them work like a charm on mobiles!</p>
