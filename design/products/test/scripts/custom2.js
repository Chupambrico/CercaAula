...
function boomerang(){
		if (xmlhttpContenuti.readyState==4){
		    ...
		    for(var i=0; i<arr.length-1;i++){
				...
				$(".result").append("<div class='container'><h4 class='heading left-text'>"+temp[0]+"</h4><p class='left-text'>"+temp[4]+"<br>Libera fino alle "+finq.getHours()+":"+finq.getMinutes()+"</p></div><div class='decoration'></div>");
