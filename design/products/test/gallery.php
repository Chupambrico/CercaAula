...
<div class="all-elements">
    ...
    <div class="page-content" id="content">
        ...
        <div class="decoration"></div>
         ...
         <ul class="gallery">
            <li>
            	<a title="An awesome gallery!" href="images/gallery/full/1.jpg" class="swipebox">
                	<img alt="Image 001" src="images/gallery/thumb/1t.jpg">
                </a>
            </li>
            <li>
            	<a title="An awesome gallery!" href="images/gallery/full/2.jpg" class="swipebox">
                	<img alt="Image 001" src="images/gallery/thumb/2t.jpg">
                </a>
            </li>
            <li>
            	<a title="An awesome gallery!" href="images/gallery/full/3.jpg" class="swipebox">
                	<img alt="Image 001" src="images/gallery/thumb/3t.jpg">
                </a>
            </li>
            <li>
            	<a title="An awesome gallery!" href="images/gallery/full/4.jpg" class="swipebox">
                	<img alt="Image 001" src="images/gallery/thumb/4t.jpg">
                </a>
            </li>
            <li>
            	<a title="An awesome gallery!" href="images/gallery/full/5.jpg" class="swipebox">
                	<img alt="Image 001" src="images/gallery/thumb/5t.jpg">
                </a>
            </li>
            <li>
            	<a title="An awesome gallery!" href="images/gallery/full/1.jpg" class="swipebox">
