		...
		<div class="all-elements">
			...
			<div id="content" class="page-content">
				...
				<div id="footer" class="footer">
					<div class="center-text" style="color:white; pading:10px 0px;">Se non sono presenti aule libere <br>nel'intervallo di tempo da voi scelto potete sempre usufruire di <a href="http://web.unitn.it/biblioteca/10221/biblioteca-centrale" target="_blank">biblioteche e aule studio!</a></div>
				</div>
			</div>
		</div>
	</body>
