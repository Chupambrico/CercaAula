		...
		<div class="all-elements">
			...
			<div id="content" class="page-content">
				...
				<div id="footer" class="footer">
					<div class="center-text" style="color:white; padding:6px 0px; font-size: .7em;">Se non sono presenti aule libere nel'intervallo di tempo da voi scelto potete sempre usufruire di <a href="http://web.unitn.it/biblioteca/10221/biblioteca-centrale" target="_blank">biblioteche e aule studio!</a><br>©FemtoWatt42</div>
				</div>
			</div>
		</div>
	</body>
